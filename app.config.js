...
const APP_VERSION = process.env.EXPO_PUBLIC_APP_VERSION || '18.0.0';
...
const config = {
    ...
    [
      'expo-audio',
      {
        microphonePermission:
          'JobNova uses the microphone for live interview practice and voice coaching.',
      },
    ],
    [
  ...
  extra: {
    apiBaseUrl:
      process.env.EXPO_PUBLIC_API_BASE_URL || 'https://jobnova-backend.onrender.com',
    ...
    eas: {
      projectId: 'bd245184-37d2-4aa4-967d-f5d0ef47c32e',
    },
  },
