            ...
            options={[
              {
                label: 'Auto',
                value: 'auto',
                sublabel: 'Use AI voice when available, device voice as fallback.',
              },
              {
                label: 'AI voice only',
                value: 'ai_voice',
                sublabel: 'Prefer generated recruiter audio.',
              },
              {
                label: 'Device voice',
                value: 'device_voice',
                sublabel: 'Use built-in speech instead of streamed audio.',
              },
            ]}
          />
        </View>
