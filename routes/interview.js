    ...
    const response = await fetch('https://api.openai.com/v1/realtime/client_secrets', {
      ...
      body: JSON.stringify({
        ...
        session: {
          ...
          instructions: `You are JobNova's recruiter-style interview coach. Conduct a realistic live interview for the role ${payload.targetRole || 'the target role'}. Ask one question at a time, sound natural, and keep coaching concise.`,
